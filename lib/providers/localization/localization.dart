...
class Localization extends InheritedWidget {
  ...
  static Localization? of(BuildContext context) {
    return context.dependOnInheritedWidgetOfExactType<Localization>();
  }
...
class AppLocalizations {
  ...
  static final Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'notificationMessage1': "Gilbert, you placed an order check your \norder history for full details",
      'notificationMessage2': "Gilbert, Thank you for shopping with us we\n have canceled order #24568.",
      'notificationMessage3': "Gilbert, your Order #24568 has been  \nconfirmed check  your order history for full details",
      ...
      'tShirt': 'T-Shirts',
      'noSearchMatch': "Sorry, we couldn't find any matching result for your Search.",
